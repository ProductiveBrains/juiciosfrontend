<!-- MODAL -->
<div id="id_Modal_CD_EM_CREATE" class="modal fade cl_modal_CD_EM_CREATE" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" style="max-width: 90%!important;margin-top:2px!important;" role="document">
        <div class="modal-content caja">
            <form id="idMiFormulario_CD_EM" name="myForm">
                <div class="modal-header-Alta-pb pb-bg-alta pb-CardHeader">
                    <h5 style="margin:0;color: rgb(255, 255, 255)"><i class="fas fa-file-upload"></i> ALTA CARTA DOCUMENTO - EMITIDA - C.U.I.L. :
                        <span class="demo-class-cuil"id="cuilpersona">xxx</span> - <span class="demo-class-apenom">yyy</span>
                    </h5>
                </div>
                <br>
                            ...
                            <div class="col s12 m6 l6 x6">
                                <div class="form-row">
                                    <div class="form-group col-md-2" hidden>
                                        ...
                                        <label for="idDataBase_EM">ID</label>
                                        <input type="text" class="form-control" id="idDataBase_EM">
                                    </div>
                                    <div class="form-group col-md-5" hidden>
                                        <i class="material-icons prefix text-danger">today</i>
                                        <label for="idFechaSistema_EM">Ingresado en Sistema</label>
                                        <input type="date" class="form-control" id="idFechaSistema_EM">
                                    </div>

                                    <div class="form-group col-md-5">
                                        <i class="material-icons prefix text-success">today</i>
                                        <label for="idFechaEmision_EM">Fecha Emision</label>
                                        <input id="idFechaEmision_EM" name="idFechaEmision_EM" type="date"
                                            class="form-control validate" required="" aria-required="true">
                                        <input type="text" class=" form-control" name="idnamecuil_EM" id="idnamecuil_EM"
                                            hidden>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <label for="idTipoReclamo_EM">Tipo de Reclamo</label>
                                        <input id="idTipoReclamo_EM" name="idTipoReclamo_EM" type="text"
                                            class="form-control validate" required="" aria-required="true">
                                    </div>
                                    <div class="form-group col-md-7">
                                        <i class="material-icons prefix text-success">event_note</i>
                                        <label for="idEstudioJuridico_EM">Estudio Juridico</label>
                                        <input id="idEstudioJuridico_EM" name="idEstudioJuridico_EM" type="text"
                                            class="form-control validate" required="" aria-required="true">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="idComentario_EM">Comentario</label>
                                        <textarea id="idComentario_EM" name="idComentario_EM" class="form-control" rows="4"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="idCartellone_EM">Cartellone Cloud
                                            <span style="font-size: 12px;color:rgb(12, 9, 211)">(Ingrese el link de
                                                sus hosting en la nube)</span> </label>
                                        <input type="text" class="form-control" id="idCartellone_EM" name="idCartellone_EM">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="card">
                                            <div class="card-image">
                                                <div id="PDF_CONTESTACIONES_CREATE" class=""></div>
                                                <span class="pb_card-title"
                                                    onclick="fullscreenFUNCTION(document.getElementById('PDF_CONTESTACIONES_CREATE'))">Vista
                                                    Maximizada &nbsp</span>
                                            </div>
                                            <div class="card-content" style="margin-top:10px;">
                                                <div class="">
                                                    <input type="file" onchange="file_changed_PDFViewer('PDF_CONTESTACIONES_CREATE')" name="archivoupload" id="id_file_pdf_CD_EM"
                                                        accept=".pdf,.jpg" class="validate" required=""
                                                        aria-required="true">
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-footer-Alta-pb d-flex align-items-center justify-content-end"
                    ...
                    <a class="btn pb-btnFooter" id="botonGrabar_EM" type="submit"
...
<script>
    $("#botonGrabar_EM").click(function (event) {

        var validaciones =0;

        if ($("#idFechaEmision_EM").val() == "") {
        ...
        if (validaciones == 4) {
            ...
            $('.cl_modal_CD_EM_CREATE').modal('hide');
            event.preventDefault(); //stop submit the form, we will post it manually.
            var form = $('#idMiFormulario_CD_EM')[0]; // Get form
            var data = new FormData(form); // Create an FormData object
            
            data.append("numerocuil", $("#cuilpersona").text());
            data.append("idFechaEmision_EM", $("#idFechaEmision_EM").val());
            data.append("idTipoReclamo_EM", $("#idTipoReclamo_EM").val());
            data.append("idEstudioJuridico_EM", $("#idEstudioJuridico_EM").val());
            data.append("idComentario_EM", $("#idComentario_EM").val());
            data.append("idCartellone_EM", $("#idCartellone_EM").val());
