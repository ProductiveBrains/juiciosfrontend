<!-- MODAL -->
<div id="id_Modal_CD_JU_CREATE" class="modal fade cl_modal_CD_JU_CREATE" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" style="max-width: 90%!important;margin-top:2px!important;" role="document">
        <div class="modal-content caja">
            <form id="idMiFormulario_JU_CREATE" name="myForm">
                <div class="modal-header-Alta-pb pb-bg-alta pb-CardHeader">
                    <h5 style="margin:0;color: rgb(255, 255, 255)"><i class="fas fa-handshake"></i> ALTA JUICIO - C.U.I.L. :
                        <span class="demo-class-cuil" id="cuilpersona_JU_CRE">xxx</span> - <span
                            ...
                            <div class="col s12 m6 l6 x6">
                                <div class="form-row">
                                    <div class="form-group col-md-2" hidden>
                                        ...
                                        <label for="idDataBase_JU_CRE">ID</label>
                                        <input type="text" class="form-control" id="idDataBase_JU_CRE">
                                    </div>
                                    <div class="form-group col-md-5" hidden>
                                        <i class="material-icons prefix text-danger">today</i>
                                        <label for="idFechaSistema_JU_CRE">Ingresado en Sistema</label>
                                        <input type="date" class="form-control" id="idFechaSistema_JU_CRE">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <label for="idTipo_JU_CRE">Tipo Juicio</label>
                                        <select id="idTipo_JU_CRE" class="form-select form-control validate"
                                    ...
                                    <div class="form-group col-md-4">
                                        <i class="material-icons prefix text-success">today</i>
                                        <label for="idFechaAudiencia_JU_CRE">Fecha Audiencia</label>
                                        <input id="idFechaAudiencia_JU_CRE" name="idFechaAudiencia_JU_CRE" type="date"
                                            class="form-control validate" required="" aria-required="true">
                                        <input type="text" class=" form-control" name="idnamecuil_JU_CRE"
                                            id="idnamecuil_JU_CRE" hidden>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <i class="material-icons prefix text-warning">mode_edit</i>
                                        <label for="idComentario_JU_CRE">Comentario</label>
                                        <textarea id="idComentario_JU_CRE" name="idComentario_JU_CRE"
                                            class="form-control" rows="4"
                                            placeholder="En Caso de Audiencia Presencial Especifique Ciudad y Lugar"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="idCartellone_JU_CRE">Cartellone Cloud
                                            <span style="font-size: 12px;color:rgb(12, 9, 211)">(Ingrese el link de
                                                sus hosting en la nube)</span> </label>
                                        <input type="text" class="form-control" id="idCartellone_JU_CRE"
                                            name="idCartellone_JU_CRE">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="card">
                                            <div class="card-image">
                                                <div id="PDF_JUICIO_CREATE" class=""></div>
                                                <span class="pb_card-title"
                                                    onclick="fullscreenFUNCTION(document.getElementById('PDF_JUICIO_CREATE'))">Vista
                                                    Maximizada &nbsp</span>
                                            </div>
                                            <div class="card-content" style="margin-top:10px;">
                                                <div class="">
                                                    <input type="file"
                                                        onchange="file_changed_PDFViewer('PDF_JUICIO_CREATE')"
                                                        name="archivoupload" id="id_file_pdf_JU_CRE" accept=".pdf,.jpg"
                ...
                <div class="modal-footer-Alta-pb d-flex align-items-center justify-content-end"
                    ...
                    <a class="btn pb-btnFooter" id="botonGrabar_JU_CRE" type="submit"
...
<script>
    $("#botonGrabar_JU_CRE").click(function (event) {

        var validaciones = 0;

        if ($("#idFechaEmision_JU_CRE").val() == "") {
        ...
        if ($("#idEstudioJuridico_JU_CRE").val() == "") {
        ...
        if (validaciones == 4) {
            ...
            $('.cl_modal_CD_JU_CREATE').modal('hide');
            event.preventDefault(); //stop submit the form, we will post it manually.
            var form = $('#idMiFormulario_JU_CREATE')[0]; // Get form
            var data = new FormData(form); // Create an FormData object

            data.append("numerocuil", $("#cuilpersona_JU_CRE").text());
            data.append("idFechaEmision_JU_CRE", $("#idFechaEmision_JU_CRE").val());
            data.append("idTipo_JU_CRE", $("#idTipo_JU_CRE option:selected" ).text()); 
            data.append("idFechaAudiencia_JU_CRE", $("#idFechaAudiencia_JU_CRE").val());
            data.append("hora_JU_CRE", $("#hora option:selected" ).text());         
            data.append("idComentario_JU_CRE", $("#idComentario_JU_CRE").val());
            data.append("idCartellone_JU_CRE", $("#idCartellone_JU_CRE").val());
